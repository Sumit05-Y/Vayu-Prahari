...
df = pd.read_csv("../DATASET/RAW/2022.csv")
...
plt.title('Average Monthly Temperature — 2022')
plt.xlabel('Month')
...
plt.title('Average Monthly Humidity — 2022')
plt.xlabel('Month')
plt.ylabel('Humidity (%)')
plt.xticks(rotation=45)
plt.tight_layout()
...
plt.title('Average Monthly Pressure — 2022')
plt.xlabel('Month')
