...
df = pd.read_csv("../DATASET/RAW/2023.csv")
...
plt.title('Average Monthly Temperature — 2023')
plt.xlabel('Month')
...
plt.title('Average Monthly Humidity — 2023')
plt.xlabel('Month')
plt.ylabel('Humidity (%)')
plt.xticks(rotation=45)
plt.tight_layout()
...
plt.title('Average Monthly Pressure — 2023')
plt.xlabel('Month')
